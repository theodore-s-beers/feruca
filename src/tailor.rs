...
pub static SING_AR: LazyLock<SinglesTable> = LazyLock::new(|| {
    let mut sing: SinglesTable = decode_from_slice(SING_CLDR_DATA, config::standard())
        .unwrap()
        .0;
    let extension: SinglesTable = decode_from_slice(SING_AR_DATA, config::standard())
        .unwrap()
        .0;
...
pub static MULT_AR: LazyLock<MultisTable> = LazyLock::new(|| {
    let mut mult: MultisTable = decode_from_slice(MULT_CLDR_DATA, config::standard())
        .unwrap()
        .0;
    let extension: MultisTable = decode_from_slice(MULT_AR_DATA, config::standard())
        .unwrap()
        .0;
...
pub static SING_AR_I: LazyLock<SinglesTable> = LazyLock::new(|| {
    let mut sing: SinglesTable = decode_from_slice(SING_CLDR_DATA, config::standard())
        .unwrap()
        .0;
    let extension: SinglesTable = decode_from_slice(SING_AR_I_DATA, config::standard())
        .unwrap()
        .0;
...
pub static MULT_AR_I: LazyLock<MultisTable> = LazyLock::new(|| {
    let mut mult: MultisTable = decode_from_slice(MULT_CLDR_DATA, config::standard())
        .unwrap()
        .0;
    let extension: MultisTable = decode_from_slice(MULT_AR_I_DATA, config::standard())
        .unwrap()
        .0;
