...
pub(crate) const NEED_THREE: [u32; 4] = [3_270, 3_545, 4_018, 4_019];

pub(crate) const NEED_TWO: [u32; 59] = [
...
pub(crate) const INCLUDED_UNASSIGNED: [u32; 4] = [177_977, 178_206, 183_970, 191_457];

//
// Static
//

pub(crate) static FCD: Lazy<HashMap<u32, u16>> = Lazy::new(|| {
